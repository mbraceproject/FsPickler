...
** 
============================================================*/
namespace Nessos.FsPickler.CSharp
{
    ...
    public class BinaryReader : IDisposable
    {
        ...
        private static readonly byte[] s_zeroByteArray = new byte[0];
        private static readonly char[] s_zeroCharArray = new char[0];
